# Epic7 PC版自動刷新神秘商店 v2.7 - DPI Scaling修改版
...
我是拿jasoncheung22的專案拿過來修改，主要修改以下幾點:
1. 螢幕縮放比例原本只能100%的問題
2. 新增了金幣和天空石判定的欄位
...
### Important Steps
1. **Right-click exe and "Run as administrator"**
2. **Don't move mouse to game window while running**
3. **Don't minimize the game window**
